...
extension ThirdVC {
    ...
    private func makeImageViewIphone() -> UIImageView {
        ...
        imageView.image = UIImage(named: "Главный2")
    ...
    private func makeLabel() -> UILabel {
        ...
        let attributeText = NSMutableAttributedString(string: "Легкий Дизайн Для Покупок")
        ...
        attributeText.apply(color: color, toSubstring: "Легкий")
    ...
    private func makeSubtitle() -> UILabel {
        let label = UILabel()
        label.text = "Купуйте та насолоджуйтеся покупкою, вибирайте з великого асортименту ексклюзивних ручок Lamy. Кожен місяць ми додаємо щось нове"
        label.textAlignment = .center
        label.numberOfLines = 0
